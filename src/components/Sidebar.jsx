...
function Sidebar({ isOpen, setIsOpen }) {
  return (
    <div
      className={`fixed flex w-[100vw] flex-col rounded-xl bg-Bgmain bg-clip-border p-4 shadow-xl shadow-blue-gray-900/5 z-10 top-0 h-screen min-[520px]:max-w-[25rem] sm:max-w-[20rem] ${
        isOpen ? "" : "hidden"
      }`}
    >
      <ImCross
        className="absolute right-0 mx-4 cursor-pointer hover:scale-125 transition-all"
